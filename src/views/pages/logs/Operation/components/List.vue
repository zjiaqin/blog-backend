...
<script setup lang="ts">
  ...
  import { listOperationLogsUsingGet, deleteOperationLogsUsingDelete } from '/@/api/apis';
  ...
  async function toDelete(id: _listResp[number]['id'] = -1) {
    ...
    try {
      await deleteOperationLogsUsingDelete({ requestBody: ids });
